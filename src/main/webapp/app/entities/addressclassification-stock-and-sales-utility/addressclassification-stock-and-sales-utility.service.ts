...
export class AddressclassificationStockAndSalesUtilityService {
    ...
    search(req?: any): Observable<HttpResponse<AddressclassificationStockAndSalesUtility[]>> {
        const options = createRequestOption(req);
        return this.http.get<AddressclassificationStockAndSalesUtility[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<AddressclassificationStockAndSalesUtility[]>) => this.convertArrayResponse(res));
    }
