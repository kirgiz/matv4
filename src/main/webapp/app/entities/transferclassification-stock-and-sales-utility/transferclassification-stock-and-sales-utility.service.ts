...
export class TransferclassificationStockAndSalesUtilityService {
    ...
    search(req?: any): Observable<HttpResponse<TransferclassificationStockAndSalesUtility[]>> {
        const options = createRequestOption(req);
        return this.http.get<TransferclassificationStockAndSalesUtility[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<TransferclassificationStockAndSalesUtility[]>) => this.convertArrayResponse(res));
    }
