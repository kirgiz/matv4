...
export class ThirdclassificationStockAndSalesUtilityService {
    ...
    search(req?: any): Observable<HttpResponse<ThirdclassificationStockAndSalesUtility[]>> {
        const options = createRequestOption(req);
        return this.http.get<ThirdclassificationStockAndSalesUtility[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<ThirdclassificationStockAndSalesUtility[]>) => this.convertArrayResponse(res));
    }
