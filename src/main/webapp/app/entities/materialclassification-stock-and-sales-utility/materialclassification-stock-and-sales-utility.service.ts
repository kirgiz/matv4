...
export class MaterialclassificationStockAndSalesUtilityService {
    ...
    search(req?: any): Observable<HttpResponse<MaterialclassificationStockAndSalesUtility[]>> {
        const options = createRequestOption(req);
        return this.http.get<MaterialclassificationStockAndSalesUtility[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<MaterialclassificationStockAndSalesUtility[]>) => this.convertArrayResponse(res));
    }
