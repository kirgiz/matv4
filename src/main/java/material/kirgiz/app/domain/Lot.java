...
public class Lot implements Serializable {
    ...
    @ManyToOne(optional = false)
    @NotNull
    private Currency sellcurrencylot;
    ...
    public Currency getSellcurrencylot() {
        return sellcurrencylot;
    }

    public Lot sellcurrencylot(Currency currency) {
        this.sellcurrencylot = currency;
        return this;
    }

    public void setSellcurrencylot(Currency currency) {
        this.sellcurrencylot = currency;
    }
