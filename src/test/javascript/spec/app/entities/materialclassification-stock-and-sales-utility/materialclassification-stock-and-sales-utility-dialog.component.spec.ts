...
import { MaterialclassificationStockAndSalesUtilityDialogComponent } from '../../../../../../main/webapp/app/entities/materialclassification-stock-and-sales-utility/materialclassification-stock-and-sales-utility-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('MaterialclassificationStockAndSalesUtility Management Dialog Component', () => {
        let comp: MaterialclassificationStockAndSalesUtilityDialogComponent;
        let fixture: ComponentFixture<MaterialclassificationStockAndSalesUtilityDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MaterialclassificationStockAndSalesUtilityDialogComponent],
                providers: [
                    MaterialclassificationStockAndSalesUtilityService
                ]
            })
            .overrideTemplate(MaterialclassificationStockAndSalesUtilityDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(MaterialclassificationStockAndSalesUtilityDialogComponent);
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'materialclassificationListModification', content: 'OK'});
