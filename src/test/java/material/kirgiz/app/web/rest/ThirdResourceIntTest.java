...
import material.kirgiz.app.repository.ThirdRepository;
import material.kirgiz.app.service.ThirdService;
import material.kirgiz.app.repository.search.ThirdSearchRepository;
import material.kirgiz.app.service.dto.ThirdDTO;
import material.kirgiz.app.service.mapper.ThirdMapper;
...
public class ThirdResourceIntTest {
    ...
    public void createThird() throws Exception {
        ...
        assertThat(thirdEs).isEqualToIgnoringGivenFields(testThird);
    }
