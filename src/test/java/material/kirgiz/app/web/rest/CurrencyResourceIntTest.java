...
import material.kirgiz.app.repository.CurrencyRepository;
import material.kirgiz.app.service.CurrencyService;
import material.kirgiz.app.repository.search.CurrencySearchRepository;
import material.kirgiz.app.service.dto.CurrencyDTO;
import material.kirgiz.app.service.mapper.CurrencyMapper;
...
public class CurrencyResourceIntTest {
    ...
    public void createCurrency() throws Exception {
        ...
        assertThat(testCurrency.getiSOCode()).isEqualTo(DEFAULT_I_SO_CODE);
    ...
    public void updateCurrency() throws Exception {
        ...
        Currency testCurrency = currencyList.get(currencyList.size() - 1);
        assertThat(testCurrency.getiSOCode()).isEqualTo(UPDATED_I_SO_CODE);
