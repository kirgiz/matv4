...
import material.kirgiz.app.service.LotService;
...
public class LotResourceIntTest {
    ...
    public static Lot createEntity(EntityManager em) {
        ...
        // Add required entity
        Currency sellcurrencylot = CurrencyResourceIntTest.createEntity(em);
        em.persist(sellcurrencylot);
        em.flush();
        lot.setSellcurrencylot(sellcurrencylot);
        return lot;
    }
    ...
    public void createLot() throws Exception {
        ...
        assertThat(lotEs).isEqualToIgnoringGivenFields(testLot);
    }
