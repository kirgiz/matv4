...
import material.kirgiz.app.domain.Country;
import material.kirgiz.app.repository.CountryRepository;
import material.kirgiz.app.service.CountryService;
import material.kirgiz.app.repository.search.CountrySearchRepository;
import material.kirgiz.app.service.dto.CountryDTO;
import material.kirgiz.app.service.mapper.CountryMapper;
...
public class CountryResourceIntTest {
    ...
    private static final String DEFAULT_I_SO_CODE = "AAA";
    private static final String UPDATED_I_SO_CODE = "BBB";
    ...
    public void createCountry() throws Exception {
        ...
        assertThat(testCountry.getiSOCode()).isEqualTo(DEFAULT_I_SO_CODE);
    ...
    public void getAllCountries() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].iSOCode").value(hasItem(DEFAULT_I_SO_CODE.toString())))
    ...
    public void getCountry() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries/{id}", country.getId()))
            ...
            .andExpect(jsonPath("$.iSOCode").value(DEFAULT_I_SO_CODE.toString()))
    ...
    public void updateCountry() throws Exception {
        ...
        Country testCountry = countryList.get(countryList.size() - 1);
        assertThat(testCountry.getiSOCode()).isEqualTo(UPDATED_I_SO_CODE);
