...
import material.kirgiz.app.service.TransferclassificationService;
...
public class TransferclassificationResourceIntTest {
    ...
    public void createTransferclassification() throws Exception {
        ...
        assertThat(transferclassificationEs).isEqualToIgnoringGivenFields(testTransferclassification);
    }
